...
//   const openPdfInNewWindow = (pdfId: string) => {
//     if (activeProjectId) {
//       const pdfUrl = `${API_BASE_URL}/projects/${activeProjectId}/pdfs/${pdfId}/download`;
...
//                 <div className="space-y-4">
//                   {currentProject.tenderFile && (
//                     <Card onClick={() => openPdfInNewWindow(currentProject.tenderFile.id)} className="cursor-pointer">
//                       <CardContent className="p-4">
//                         <div className="flex items-center gap-3">
//                           <FileText className="h-5 w-5 text-green-600" />
//                           <div className="flex-1">
...
//                   {currentProject.bidFiles.map((file) => (
//                     <Card key={file.id} onClick={() => openPdfInNewWindow(file.id)} className="cursor-pointer">
//                       <CardContent className="p-4">
//                         <div className="flex items-center gap-3">
//                           <FileText className="h-5 w-5 text-orange-600" />
//                           <div className="flex-1">
