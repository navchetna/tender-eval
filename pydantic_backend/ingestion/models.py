...
class Project(BaseModel):
    ...
    # True once an up-to-date final comparison has been generated for current_version — see
    # PostgresRepository.list_projects, which derives this from llm_result_cache (kind='compare').
