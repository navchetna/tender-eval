...
Base URL example: https://ei-api.mg2.eglb.intel.com/pdf-pipeline
...
class ParserClient:
    def __init__(self, settings: Settings) -> None:
        ...
        self._client = httpx.AsyncClient(headers=headers, timeout=120.0, verify=settings.parser_verify_tls)
