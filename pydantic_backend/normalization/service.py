...
async def build_view(
    ...
    for bid_record in bid_records:
        ...
        header_mapping = await match_headers(creds, tender_columns, bid_header_list) if bid_header_list and tender_columns else {}
        indices = await match_rows(creds, tender_texts, bid_texts) if tender_texts else []
